...
class _OverviewViewState extends State<OverviewView> {
  ...
  void didChangeDependencies() {
    ...
    if (!_requestedInitialRefresh && connection.hasTarget && overview.overviewSnapshot == null) {
  ...
  Widget build(BuildContext context) {
    ...
    final overview = context.read<OverviewCubit>();
    final services = context.read<ServicesCubit>();
    final history = context.read<OperationHistoryCubit>();

    return ListenableBuilder(
      listenable: Listenable.merge([connection, runner, overview, services, history]),
      builder: (context, _) {
